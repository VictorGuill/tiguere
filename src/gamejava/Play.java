        ...
        do {
            switch (INPUT) {
                case "up":
                    ...
                    Enemies.moveEnemies(GameJava.enemies, widthBoard, heightBoard, Board.voidSquare);
                    Board.printBoard(widthBoard, heightBoard);
                    Board.showMenu();
                    INPUT = "";
                    break;
                ...
                case "right":
                    ...
                    break;
                case "1":
                    Player.basicAttack(board, playable, character, widthBoard, heightBoard, Board.Enemy);
                    break;
                case "2":
