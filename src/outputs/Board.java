...
public class Board {
    ...
    public static void randomPositions(int number, int rowLimit, int columnLimit, String icon, Enemies[] enemies) {
        int counter = 0;
    ...
    public static void randomEnemies(int number, int rowLimit, int columnLimit, String icon){
        int counter = 0;
        int rowPosition, columnPosition;
    ...
    public static void setMap(int width, int height) {
        ...
        randomPositions(GameJava.numCoins, height - 1, width - 1, Coin);
